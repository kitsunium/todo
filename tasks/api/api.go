...
var (
	...
	_ = tasks.Service.Endpoint("POST /api/tasks", Create, kit.Auth(), kit.RateLimit(10, 20))
	_ = tasks.Service.Endpoint("GET /api/tasks/{id}", Get, kit.Auth())
	_ = tasks.Service.Endpoint("PATCH /api/tasks/{id}", Update, kit.Auth(), kit.RateLimit(10, 20))
	_ = tasks.Service.Endpoint("POST /api/tasks/{id}/complete", Complete, kit.Auth(), kit.RateLimit(10, 20))
	_ = tasks.Service.Endpoint("POST /api/tasks/{id}/reopen", Reopen, kit.Auth(), kit.RateLimit(10, 20))
	_ = tasks.Service.Endpoint("POST /api/tasks/{id}/archive", Archive, kit.Auth(), kit.RateLimit(10, 20))
	_ = tasks.Service.Endpoint("POST /api/tasks/{id}/restore", Restore, kit.Auth(), kit.RateLimit(10, 20))
	_ = tasks.Service.Endpoint("DELETE /api/tasks/{id}", Delete, kit.Auth(), kit.RateLimit(10, 20))
	_ = tasks.Service.Endpoint("POST /api/tasks/{id}/share", Share, kit.Auth(), kit.RateLimit(10, 20))
	_ = tasks.Service.Endpoint("DELETE /api/tasks/{id}/share/{userId}", Unshare, kit.Auth(), kit.RateLimit(10, 20))
)
