...
of each, every request as a trace, the workflows and their populations, the
daemon's loops, and the mails it sent.

| **Context** — who uses the product, what it talks to (C4 level 1) | **Infrastructure** — its containers, and inside the process (C4 level 2) |
|---|---|
| ![Context](docs/studio-context.png) | ![Infrastructure](docs/studio-infrastructure.png) |
| **Domain** — the bounded contexts and how they talk (C4 level 3) | **Code** — what a node runs, what it touches (C4 level 4) |
| ![Domain](docs/studio-domain.png) | ![Code](docs/studio-code.png) |
| **Requests** — every request as a sequence of the nodes it crossed | **States** — a workflow, its population and its instances |
...
| **Overview** — health, traffic, what needs a look | |
| ![Overview](docs/studio-overview.png) | |
